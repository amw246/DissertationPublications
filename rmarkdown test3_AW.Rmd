...
\centering
  \begin{subfigure}[t]{1\textwidth}
		\includegraphics[angle=0, scale=0.6] {/Users/andrewwallace/Downloads/A_36/A_16}
		\caption{Early Drop Outs}
	\end{subfigure}
	\begin{subfigure}[t]{1\textwidth}
```{r, echo = FALSE, results = 'asis', message = FALSE, }
library(TraMineR)
...
```
		\caption{BA2}
	\end{subfigure}
\caption{Top Twenty Sequences, BA1 and BA2}
\label{fig:Top20SeqBA}
\end{figure}
